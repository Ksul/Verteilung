...
<r:page titleId="title_browse">
   ...
   function applySize(e, field)
   {
      ...
      if (keycode == 13)
      {
         document.forms['browsemod']['browsemod:act'].value='browsemod:' + field;
         document.forms['browsemod'].submit();
         return false;
      }
      return true;
   }
   ...
   %>
		...
		<h:form acceptcharset="UTF-8" id="browsemod">
			...
			<table cellspacing="0" cellpadding="2" width="100%">
				...
				<tr valign="top">
					...
					<td style="white-space: nowrap;"><%@ include
							file="../parts/shelf.jsp"%></td>

					<%-- Work Area --%>
					<td
						width="<h:outputText value="#{NavigationBean.workAreaWidth}" />">
						<table cellspacing=0 cellpadding=0 width='100%'>
									...
									<table cellspacing=4 cellpadding=0 width='100%'>
										<tr>
												...
												<td>
													...
													<div class="mainTitle">
														...
														<a:actionLink image="/images/icons/opennetwork.gif"
															...
															target="new" id="cifs" />
														&nbsp;
														<a:actionLink id="actRSS" value="#{msg.rss_feed_link}"
															showLink="false" image="/images/icons/rss.gif"
															href="#{NavigationBean.RSSFeedURL}"
															rendered="#{NavigationBean.RSSFeed == true}" />
													</div>
													...
													<div class="mainSubText">
														<h:outputText
															value="#{NavigationBean.nodeProperties.description}"
															id="msg4" />
													</div>
												</td>
												<td style="padding-right: 4px" align=right><nobr>
														<%-- Additional summary info --%>
														<h:graphicImage id="img-rule" url="/images/icons/rule.gif"
															width="16" height="16" title="#{msg.rules_count}" />
														<h:outputText value="(#{NavigationBean.ruleCount})"
															id="rulemsg1" style="vertical-align:20%" />
													</nobr>
												</td>
												<td class="separator" width=1><img
													src="<%=request.getContextPath()%>/images/parts/dotted_separator.gif"
													border=0 height=29 width=1></td>
												<td style="padding-left: 4px; white-space: nowrap"
													align="right">
													<%-- Quick upload action --%> <r:actions
														id="acts_add_content" value="add_content_menu"
														context="#{NavigationBean.currentNode}" showLink="true" />
												</td>
												<td style="padding-left: 4px" width=52>
													<%-- Create actions menu --%> <a:menu id="createMenu"
														itemSpacing="4" label="#{msg.create_options}"
														image="/images/icons/menu.gif"
														menuStyleClass="moreActionsMenu"
														style="white-space:nowrap"
														rendered="#{NavigationBean.createChildrenPermissionEnabled}">
														<r:actions id="acts_create" value="browse_create_menu"
															context="#{NavigationBean.currentNode}" />
													</a:menu>
												</td>
												<td style="padding-left: 4px" width=80>
													<%-- More actions menu --%> <a:menu id="actionsMenu"
														itemSpacing="4" label="#{msg.more_actions}"
														image="/images/icons/menu.gif"
														menuStyleClass="moreActionsMenu"
														style="white-space:nowrap">
											...
											<a:panel id="search-actions"
												rendered="#{NavigationBean.searchContext != null}">
												<td width=32><img
													src="<%=request.getContextPath()%>/images/icons/search_results_large.gif"
													width=32 height=32>
												</td>
												<td>
													<%-- Summary --%>
												...
												<td style="padding-right: 4px" align=right>
													<%-- Close Search action --%> <nobr>
														<a:actionLink value="#{msg.close_search}"
															image="/images/icons/action.gif"
															style="white-space:nowrap"
															actionListener="#{BrowseBean.closeSearch}" id="link21" />
													</nobr>
												</td>
												<td style="padding-right: 4px" width=80>
													<%-- New Search actions --%> <nobr>
														<a:actionLink value="#{msg.new_search}"
															image="/images/icons/search_icon.gif"
															style="white-space:nowrap" action="advSearch" id="link20" />
													</nobr>
												</td>
												<td style="padding-left: 4px" width=90>
													<%-- More Search actions --%> <a:menu id="searchMenu"
														itemSpacing="4" label="#{msg.more_actions}"
														image="/images/icons/menu.gif"
														menuStyleClass="moreActionsMenu"
														style="white-space:nowrap">
														<a:booleanEvaluator
															value="#{NavigationBean.isGuest == false}" id="eval0">
															<a:actionLink value="#{msg.save_new_search}"
																image="/images/icons/save_search.gif" padding="4"
																action="#{AdvancedSearchDialog.saveNewSearch}"
																id="link20_1" />
															<a:booleanEvaluator
																value="#{AdvancedSearchDialog.allowEdit == true}"
																id="eval0_1">
																<a:actionLink value="#{msg.save_edit_search}"
																	image="/images/icons/edit_search.gif" padding="4"
																	action="#{AdvancedSearchDialog.saveEditSearch}"
																	id="link20_2" />
															</a:booleanEvaluator>
														</a:booleanEvaluator>
													</a:menu>
											...
											<td width=118 valign=middle>
												<%-- View mode settings --%> <a:modeList id="viewMode"
													...
													menuImage="/images/icons/menu.gif"
													styleClass="moreActionsMenu">
													...
													<a:listItem value="dashboard" label="#{msg.custom_view}"
														disabled="#{!NavigationBean.hasCustomView}" />
												</a:modeList>
											</td>
										</tr>
									</table>
							...
							<h:outputText id="sites-space-warning"
								rendered="#{BrowseBean.sitesSpace}"
								value="#{BrowseBean.sitesSpaceWarningHTML}" escape="false" />

							<%-- Custom Template View --%>
							<a:panel id="custom-wrapper-panel"
								rendered="#{NavigationBean.hasCustomView && NavigationBean.searchContext == null}">
								<tr valign="top">
									<td
										style="background-image: url(<%=request.getContextPath()%>/images/parts/whitepanel_4.gif)"
										width=4></td>
									<td style="padding: 4px"><a:panel id="custom-panel"
											border="white" bgcolor="white" titleBorder="lbgrey"
											expandedTitleBorder="dotted" titleBgcolor="white"
											styleClass="mainSubTitle" label="#{msg.custom_view}"
											progressive="true"
											expanded='#{BrowseBean.panels["custom-panel"]}'
											expandedActionListener="#{BrowseBean.expandPanel}">
											<r:webScript id="webscript"
												scriptUrl="#{NavigationBean.currentNodeWebscript}"
												context="#{NavigationBean.currentNode.nodeRef}"
												rendered="#{NavigationBean.hasWebscriptView}" />
											<r:template id="template"
												template="#{NavigationBean.currentNodeTemplate}"
												model="#{NavigationBean.templateModel}"
												rendered="#{!NavigationBean.hasWebscriptView && NavigationBean.hasTemplateView}" />
										</a:panel>
									</td>
									<td
									...
									<h:panelGroup id="spaces-panel-facets">
										<f:facet name="title">
											<a:panel id="page-controls1" style="font-size:9px">
												...
												<a:actionLink id="spaces-apply" value=""
													actionListener="#{BrowseBean.updateSpacesPageSize}" />
												<f:verbatim>
													</div>
												</f:verbatim>
											</a:panel>
										...
										expanded='#{BrowseBean.panels["spaces-panel"]}'
										expandedActionListener="#{BrowseBean.expandPanel}">

										<%-- Spaces List --%>
										<a:richList id="spacesList"
											binding="#{BrowseBean.spacesRichList}"
											viewMode="#{BrowseBean.browseViewMode}"
											pageSize="#{BrowseBean.pageSizeSpaces}"
											...
											<f:facet name="empty">
												...
												<h:outputFormat id="no-space-items"
													value="#{msg.no_space_items}" escape="false"
													rendered="#{NavigationBean.searchContext == null}">
											...
											<a:column id="col1" primary="true"
												...
												<r:nodeInfo id="col1-info" value="#{r.id}">
													<h:graphicImage id="col1-img" url="/images/icons/popup.gif"
														styleClass="popupImage" width="16" height="16" />
												</r:nodeInfo>
											</a:column>
											...
											<a:column id="col2" primary="true"
												...
												<r:nodeInfo id="col2-info" value="#{r.id}">
													<h:graphicImage id="col2-img" url="/images/icons/popup.gif"
														styleClass="popupImage" width="16" height="16" />
												</r:nodeInfo>
											</a:column>
											...
											<a:column id="col3" primary="true"
												...
												<r:nodeInfo id="col3-info" value="#{r.id}">
													<h:graphicImage id="col3-img" url="/images/icons/popup.gif"
														styleClass="popupImage" width="16" height="16" />
												</r:nodeInfo>
											</a:column>
											...
											<a:column id="col5" style="text-align:left"
												rendered="#{NavigationBean.searchContext != null && BrowseBean.browseViewMode == 'details'}">
												<f:facet name="header">
							...
							<tr valign="top">
								<td
									style="background-image: url(<%=request.getContextPath()%>/images/parts/whitepanel_4.gif)"
									width=4></td>
								<td style="padding: 4px"><h:panelGroup
										id="content-panel-facets">
										<f:facet name="title">
											<a:panel id="page-controls2" style="font-size:9px">
												...
												<a:actionLink id="content-apply" value=""
													actionListener="#{BrowseBean.updateContentPageSize}" />
												<f:verbatim>
													</div>
												</f:verbatim>
											</a:panel>
										...
										<a:richList id="contentRichList"
											...
											<a:column id="col10" primary="true"
												...
												rendered="#{BrowseBean.browseViewMode == 'details'}">
												<f:facet name="header">
													<a:sortLink id="col10-sort" label="#{msg.name}"
														value="name" mode="case-insensitive" styleClass="header" />
												</f:facet>
												<f:facet name="small-icon">
													<a:actionLink id="col10-act1" value="#{r.name}"
														href="#{r.url}" target="new" image="#{r.fileType16}"
														showLink="false" styleClass="inlineAction" />
												</f:facet>
												<a:actionLink id="col10-act2" value="#{r.name}"
													href="#{r.url}" target="new" />
												<r:lockIcon id="col10-lock" value="#{r.nodeRef}"
													align="absmiddle" />
												<h:outputLabel id="col10-lang" value="#{r.lang}"
													styleClass="langCode" rendered="#{r.lang != null}" />
												<r:nodeInfo id="col10-info" value="#{r.id}">
													<h:graphicImage id="col10-img"
														url="/images/icons/popup.gif" styleClass="popupImage"
														width="16" height="16" />
												</r:nodeInfo>
											</a:column>
											...
											<a:column id="col11" primary="true"
												...
												rendered="#{BrowseBean.browseViewMode == 'icons'}">
												<f:facet name="large-icon">
													<a:actionLink id="col11-act1" value="#{r.name}"
														href="#{r.url}" target="new" image="#{r.fileType32}"
														showLink="false" styleClass="inlineAction" />
												</f:facet>
												<a:actionLink id="col11-act2" value="#{r.name}"
													href="#{r.url}" target="new" styleClass="header" />
												<r:lockIcon id="col11-lock" value="#{r.nodeRef}"
													align="absmiddle" />
												<h:outputLabel id="col11-lang" value="#{r.lang}"
													styleClass="langCode" rendered="#{r.lang != null}" />
												<r:nodeInfo id="col11-info" value="#{r.id}">
													<h:graphicImage id="col11-img"
														url="/images/icons/popup.gif" styleClass="popupImage"
														width="16" height="16" />
												</r:nodeInfo>
											</a:column>
											...
											<a:column id="col12" primary="true"
												...
												rendered="#{BrowseBean.browseViewMode == 'list'}">
												<f:facet name="large-icon">
													<a:actionLink id="col12-act1" value="#{r.name}"
														href="#{r.url}" target="new" image="#{r.fileType32}"
														showLink="false" styleClass="inlineAction" />
												</f:facet>
												<a:actionLink id="col12-act2" value="#{r.name}"
													href="#{r.url}" target="new" styleClass="title" />
												<r:lockIcon id="col12-lock" value="#{r.nodeRef}"
													align="absmiddle" />
												<h:outputLabel id="col12-lang" value="#{r.lang}"
													styleClass="langCode" rendered="#{r.lang != null}" />
												<r:nodeInfo id="col12-info" value="#{r.id}">
													<h:graphicImage id="col12-img"
														url="/images/icons/popup.gif" styleClass="popupImage"
														width="16" height="16" />
												</r:nodeInfo>
											</a:column>

											<%-- Title column for all view modes --%>
											<a:column id="col33" style="text-align:left">
												<f:facet name="header">
													<a:sortLink id="col33-sort" label="#{msg.title}"
														value="title" styleClass="header" />
												</f:facet>
												<h:outputText id="col33-txt" value="#{r.title}" />
											</a:column>
											...
											<%-- Person column for all view modes --%>
											<a:column id="col34" style="text-align:left">
												<f:facet name="header">
													<a:sortLink id="col34-sort" label="Person"
														value="person" styleClass="header" />
												</f:facet>
												<h:outputText id="col34-txt" value="#{r['my:person']}" />
											</a:column>
											<%-- Amount for details/icons view modes --%>
											<a:column id="col35" style="text-align:left"
												rendered="#{BrowseBean.browseViewMode == 'details' || BrowseBean.browseViewMode == 'icons'}">
												<f:facet name="header">
													<a:sortLink id="col35-sort" label="Betrag"
														value="my:amount" styleClass="header" />
												</f:facet>
												<h:outputText id="col35-txt" value="#{r['my:amount']}">
													<f:convertNumber maxFractionDigits="2" groupingUsed="true"
														currencyCode="EUR" maxIntegerDigits="7" type="currency" />
												</h:outputText>
											</a:column>

											<%-- Created Date column for details view mode --%>
											<a:column id="col36" style="text-align:left"
												rendered="#{BrowseBean.browseViewMode == 'details'}">
												<f:facet name="header">
													<a:sortLink id="col36-sort" label="#{msg.created}"
														value="my:documentDate" styleClass="header" />
												</f:facet>
												<h:outputText id="col36-txt" value="#{r['my:documentDate']}">
													<a:convertXMLDate type="both" pattern="dd.MM.yyyy" />
												</h:outputText>
											</a:column>

											<%-- Modified Date column for details/icons view modes --%>
											<a:column id="col37" style="text-align:left"
												rendered="#{BrowseBean.browseViewMode == 'details' || BrowseBean.browseViewMode == 'icons'}">
												<f:facet name="header">
													<a:sortLink id="col37-sort" label="IDs" value="my:idvalue"
														styleClass="header" />
												</f:facet>
												<h:outputText id="col37-txt" value="#{r['my:idvalue']}">
												</h:outputText>
											</a:column>
							...
							<tr valign="top">
								...
								<td style="padding: 4px">
									...
									<a:errors message="" infoClass="statusWarningText"
										errorClass="statusErrorText" />
								</td>
								<td
									style="background-image: url(<%=request.getContextPath()%>/images/parts/whitepanel_6.gif)"
									width=4></td>
