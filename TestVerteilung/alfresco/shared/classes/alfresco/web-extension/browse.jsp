                  ...
                  <td style="padding:4px">
                     ...
                     <a:richList id="contentRichList" binding="#{BrowseBean.contentRichList}" viewMode="#{BrowseBean.browseViewMode}" pageSize="#{BrowseBean.pageSizeContent}"
                        ...
                        <a:column id="col13" style="text-align:left">
                           <f:facet name="header">
                              <a:sortLink id="col13-sort" label="#{msg.title}" value="title" styleClass="header"/>
                           </f:facet>
                           <h:outputText id="col13-txt" value="#{r.title}" />
                        </a:column>
                        ...
                        <a:column id="col15" style="text-align:left" rendered="#{BrowseBean.browseViewMode == 'details' || BrowseBean.browseViewMode == 'icons'}">
                           <f:facet name="header">
                              <a:sortLink id="col15-sort" label="Betrag" value="my:amount" styleClass="header"/>
                           </f:facet>
                           <h:outputText id="col15-txt" value="#{r['my:amount']}">
                        ...
                        <a:column id="col16" style="text-align:left" rendered="#{BrowseBean.browseViewMode == 'details'}">
                           <f:facet name="header">
                              <a:sortLink id="col16-sort" label="#{msg.created}" value="my:documentDate" styleClass="header"/>
                           </f:facet>
                           <h:outputText id="col16-txt" value="#{r['my:documentDate']}">
                        ...
                        <a:column id="col17" style="text-align:left" rendered="#{BrowseBean.browseViewMode == 'details' || BrowseBean.browseViewMode == 'icons'}">
                           <f:facet name="header">
                              <a:sortLink id="col17-sort" label="ID" value="my:idvalue" styleClass="header"/>
                           </f:facet>
                           <h:outputText id="col17-txt" value="#{r['my:idvalue']}">
                           </h:outputText>
                        </a:column>
