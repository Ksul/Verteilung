...
(function (window, document, undefined) {
    ...
    var factory = function ($, DataTable) {
        ...
        makeEditable = function (oInit, options) {
            ...
            function fnUpdateRowOnSuccess(nActionForm) {
                ...
                for (var rel = 0; rel < iColumnCount; rel++) {
                    if (oSettings.aoColumns != null
                        && oSettings.aoColumns[rel] != null
                        && isNaN(parseInt(oSettings.aoColumns[0].mDataProp))) {
                        var sCellValue = rowData[oSettings.aoColumns[rel].mDataProp];
                    } else {
                        var sCellValue = values[rel];
                    }
            ...
            oTable = new $.fn.dataTable.Api( oInit );
        ...
        $.fn.dataTable.makeEditable = makeEditable;
        $.fn.DataTable.makeEditable = makeEditable;
    ...
    else if ( jQuery && !jQuery.fn.dataTable.makeEditable ) {
