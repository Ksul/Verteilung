...
function startSearch(searchText) {
    try {
        ...
        if (json.success) {
            ...
            //$('#alfrescoSearchTableFooter').width(alfrescoLayout.center.children.alfrescoCenterInnerLayout.state.center.innerWidth);
...
/**
 * lädt und konvertiert die Daten für den Tree
